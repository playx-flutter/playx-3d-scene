...
Playx3dScene(
	model: GlbModel.url(  
	 "https://github.com/KhronosGroup/glTF-Sample-Models/raw/master/2.0/Fox/glTF-Binary/Fox.glb",   // load glb from direct url of glb file.
...
//usually the material file contains values for these properties, but if we want to customize it we can like that.
parameters: [
